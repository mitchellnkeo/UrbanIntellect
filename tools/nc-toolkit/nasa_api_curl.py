...
def filter_collections(collections):
    ...
    print("Applying filters: L3 + Aerosol (AER/AOD/AOP) - Ocean Color (OC/CHL/CARBON)")
    filtered = []
    for col in collections:
        ...
        # 2. Filter for aerosol products - ADDED 'AOP' for PACE
        is_aerosol = any(term in short_name for term in ['AER', 'AOD', 'AE', 'AOP'])
        
        # 3. Filter out ocean color products
